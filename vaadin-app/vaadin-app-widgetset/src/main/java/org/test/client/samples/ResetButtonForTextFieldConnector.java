package org.test.client.samples;
...
import org.test.samples.ResetButtonForTextField;
...
public class ResetButtonForTextFieldConnector extends
    ...
    /*-{
        ...
        el.onclick = $entry(function () {
            self.@org.test.client.samples.ResetButtonForTextFieldConnector::clearTextField()();
        });
    }-*/;
