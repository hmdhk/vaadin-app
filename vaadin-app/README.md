...
- vaadin-app-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadin-app-ui: main application module, development time
- vaadin-app-production: module that produces a production mode WAR for deployment
